...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingCell.Factory.of(99, IconBackgroundColors.PURPLE.top, IconBackgroundColors.PURPLE.bottom, R.drawable.settings_chat, getString(R.string.ForkSettings), getString(R.string.ForkSettingsInfo)));
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            ...
            case 10:
                ...
                break;
            case 99:
                presentSettingFragment(new org.telegram.messenger.ForkSettingsActivity());
                break;
